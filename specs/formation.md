# Formation standard specification (draft)

This document defines the Formation standard at a high level. The canonical schemas in `/formation` are the source of truth.
...
Formation includes a standard `extensions` surface:
