# Formation Project Charter

## Mission

The Formation project provides a **vendor-neutral, declarative configuration standard** for AI agents and multi-agent systems. Our mission is to enable portable, interoperable agent definitions that can be validated consistently and run on any compliant runtime.

## Scope

### In scope

- **Formation schemas**: Core schema definitions for formations, agents, MCP tool servers, and A2A services.
...
- **Mappings**: Documentation mapping Formation concepts to other agent ecosystems.
...
Formation is intended to be contributed to the Agentic AI Foundation (AAIF) under the Linux Foundation. Upon acceptance, governance and IP policies will align with AAIF requirements.
